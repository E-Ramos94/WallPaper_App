...
public class VideojuegosA extends AppCompatActivity {
    ...
    private void ListarImaganesVideojuego() {
        ...
        sharedPreferences = VideojuegosA.this.getSharedPreferences("VIDEOJUEGO", MODE_PRIVATE);
        ...
        recyclerViewVideojuego.setLayoutManager(new GridLayoutManager(VideojuegosA.this, spanorder));
        firebaseRecycleAdapter.startListening();
        recyclerViewVideojuego.setAdapter(firebaseRecycleAdapter);
    }
